...
interface BuscarAnuncioMapper {
    ...
    /**
     * Dado el id de catalogo departamento, se retornan todos los anuncios que
     * pertenecen a este.
     *
     * @param id id del catalogo departamento que contiene a los anuncios
     *           retornados.
    ...
    /**
     * Dado el id de catalogo condicion, se retornan todos los anuncios que
     * pertenecen a este.
     *
    ...
    /**
     * Dado el id de la forma de pago, se retornan todos los anuncios que pertenecen
     * a este.
     *
    ...
    /**
     * Dado el id de la zona de entrega, se retornan todos los anuncios que
     * pertenecen a este.
     *
